...
def main():
    ...
    config = {
        ...
        'num_trials': 10,
        'matrix_types': ['orthogonal'],#['gaussian', 'heavy', 'orthogonal'],
        'param_grids': {
            'AMP': {
                'alpha': [0.1, 0.5, 0.9],
                'tau': [0.01, 0.1, 0.5],
        ...
        'data_types': [
            {'is_2d': False, 'name': 'complex_signal', 'num_features': 900, 'num_samples': 700, 'shape_2d': None}
        ]
    }
    ...
    for data_type in config['data_types']:
        ...
        # Adjust matrix_types if necessary
        matrix_types = config['matrix_types'].copy()
        if num_samples > num_features and 'orthogonal' in matrix_types:
            matrix_types.remove('orthogonal')
            print("Skipping 'orthogonal' matrix type because num_samples > num_features")
            logging.info("Skipping 'orthogonal' matrix type because num_samples > num_features")
